...
const moodOptions = [
  { id: 'stressed', name: 'Stressed', icon: Zap, color: 'from-hc-warning to-hc-secondary', description: 'Need to unwind and relax' },
  { id: 'anxious', name: 'Anxious', icon: Brain, color: 'from-hc-accent to-hc-primary', description: 'Looking for calm and peace' },
  { id: 'tired', name: 'Tired', icon: Moon, color: 'from-hc-secondary to-hc-accent', description: 'Need rest and restoration' },
  { id: 'unfocused', name: 'Unfocused', icon: Target, color: 'from-hc-primary to-hc-accent', description: 'Want clarity and concentration' },
  { id: 'energized', name: 'Energized', icon: Sun, color: 'from-hc-tertiary to-hc-primary', description: 'Ready for active practices' },
